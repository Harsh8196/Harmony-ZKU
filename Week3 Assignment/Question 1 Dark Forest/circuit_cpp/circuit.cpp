...
void RangeProof_2_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void RangeProof_2_run(uint ctx_index,Circom_CalcWit* ctx);
void MultiRangeProof_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void MultiRangeProof_3_run(uint ctx_index,Circom_CalcWit* ctx);
...
void move_10_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void move_10_run(uint ctx_index,Circom_CalcWit* ctx);
Circom_TemplateFunction _functionTable[11] = { 
Num2Bits_0_run,
LessThan_1_run,
RangeProof_2_run,
MultiRangeProof_3_run,
Num2Bits_4_run,
LessThan_5_run,
IsZero_6_run,
IsEqual_7_run,
...
uint get_total_signal_no() {return 6272;}

uint get_number_of_components() {return 64;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 4767;}

uint get_size_of_constants() {return 443;}
...
// load src
Fr_add(&expaux[0],&circuitConstants[5],&signalValues[mySignalStart + 0]); // line circom 15
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&circuitConstants[1]); // line circom 17
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 17. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[0],&circuitConstants[5],&signalValues[mySignalStart + 0]); // line circom 20
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[1]].signalStart + 0],&circuitConstants[1]); // line circom 21
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 21. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
}

void MultiRangeProof_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather){
ctx->componentMemory[coffset].templateId = 3;
ctx->componentMemory[coffset].templateName = "MultiRangeProof";
ctx->componentMemory[coffset].signalStart = soffset;
...
for (uint i = 0; i < 4; i++) {
std::string new_cmp_name = "rangeProofs"+ctx->generate_position_array(aux_dimensions, 1, i);
mySubcomponents[aux_create+i] = aux_cmp_num;
RangeProof_2_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 91 ;
aux_cmp_num += 5;
}
}
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[7]); // line circom 30
while(Fr_isTrue(&expaux[0])){
{
...
RangeProof_2_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_lt(&expaux[0],&lvar[221],&circuitConstants[10]); // line circom 275
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[1],&lvar[221],&circuitConstants[1]); // line circom 276
Fr_eq(&expaux[2],&lvar[221],&circuitConstants[440]); // line circom 276
...
Fr_lt(&expaux[0],&lvar[221],&circuitConstants[440]); // line circom 284
if(Fr_isTrue(&expaux[0])){
...
uint csoffset = mySignalStart+5535;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "rpx1x2";
mySubcomponents[aux_create+i] = aux_cmp_num;
MultiRangeProof_3_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 368 ;
aux_cmp_num += 21;
}
}
...
uint csoffset = mySignalStart+5903;
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "rpx2x3";
mySubcomponents[aux_create+i] = aux_cmp_num;
MultiRangeProof_3_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 368 ;
aux_cmp_num += 21;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "ltDist";
mySubcomponents[aux_create+i] = aux_cmp_num;
LessThan_5_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
csoffset += 37 ;
aux_cmp_num += 2;
...
for (uint i = 0; i < 1; i++) {
std::string new_cmp_name = "isEqual_";
mySubcomponents[aux_create+i] = aux_cmp_num;
...
uint csoffset = mySignalStart+1995;
for (uint i = 0; i < 1; i++) {
...
// need to run sub component
assert(!(--ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter));
MultiRangeProof_3_run(mySubcomponents[cmp_index_ref],ctx);
}
{
uint cmp_index_ref = 1;
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 5]); // line circom 52
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 6],&signalValues[mySignalStart + 6]); // line circom 53
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 9],&signalValues[mySignalStart + 9]); // line circom 54
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 11],&signalValues[mySignalStart + 12]); // line circom 55
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// no need to run sub component
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[2]].signalStart + 0],&circuitConstants[2]); // line circom 57
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 7],&signalValues[mySignalStart + 7]); // line circom 65
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 8],&signalValues[mySignalStart + 8]); // line circom 66
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 14],&signalValues[mySignalStart + 15]); // line circom 68
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// no need to run sub component
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[3]].signalStart + 0],&circuitConstants[2]); // line circom 70
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 70. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
PFrElement aux_dest = &signalValues[mySignalStart + 17];
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 5]); // line circom 75
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 6]); // line circom 77
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 17],&signalValues[mySignalStart + 17]); // line circom 82
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 18],&signalValues[mySignalStart + 18]); // line circom 83
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 19],&signalValues[mySignalStart + 20]); // line circom 84
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// no need to run sub component
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_mul(&expaux[1],&signalValues[mySignalStart + 10],&signalValues[mySignalStart + 10]); // line circom 85
Fr_add(&expaux[0],&expaux[1],&circuitConstants[2]); // line circom 85
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[4]].signalStart + 0],&circuitConstants[2]); // line circom 86
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 86. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
PFrElement aux_dest = &signalValues[mySignalStart + 21];
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 5]); // line circom 91
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 6]); // line circom 93
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 21],&signalValues[mySignalStart + 21]); // line circom 98
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 22],&signalValues[mySignalStart + 22]); // line circom 99
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 23],&signalValues[mySignalStart + 24]); // line circom 100
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// no need to run sub component
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_mul(&expaux[1],&signalValues[mySignalStart + 10],&signalValues[mySignalStart + 10]); // line circom 101
Fr_add(&expaux[0],&expaux[1],&circuitConstants[2]); // line circom 101
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[5]].signalStart + 0],&circuitConstants[2]); // line circom 102
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 102. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
PFrElement aux_dest = &signalValues[mySignalStart + 25];
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 7]); // line circom 107
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 6],&signalValues[mySignalStart + 8]); // line circom 109
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 25],&signalValues[mySignalStart + 25]); // line circom 114
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 26],&signalValues[mySignalStart + 26]); // line circom 115
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 27],&signalValues[mySignalStart + 28]); // line circom 116
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// no need to run sub component
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_mul(&expaux[1],&signalValues[mySignalStart + 10],&signalValues[mySignalStart + 10]); // line circom 117
Fr_add(&expaux[0],&expaux[1],&circuitConstants[2]); // line circom 117
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// need to run sub component
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[6]].signalStart + 0],&circuitConstants[2]); // line circom 118
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 118. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
PFrElement aux_dest = &signalValues[mySignalStart + 29];
// load src
Fr_sub(&expaux[0],&signalValues[mySignalStart + 8],&signalValues[mySignalStart + 4]); // line circom 122
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 3],&signalValues[mySignalStart + 26]); // line circom 124
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 5],&signalValues[mySignalStart + 29]); // line circom 126
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + 7],&signalValues[mySignalStart + 22]); // line circom 128
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_add(&expaux[3],&signalValues[mySignalStart + 30],&signalValues[mySignalStart + 31]); // line circom 130
Fr_add(&expaux[2],&expaux[3],&signalValues[mySignalStart + 32]); // line circom 130
Fr_mul(&expaux[0],&circuitConstants[442],&expaux[2]); // line circom 130
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[7]].signalStart + 0],&circuitConstants[1]); // line circom 135
if (!Fr_isTrue(&expaux[0])) std::cout << "Failed assert in template " << myTemplateName << " line 135. " <<  "Followed trace: " << ctx->getTrace(myId) << std::endl;
assert(Fr_isTrue(&expaux[0]));
{
