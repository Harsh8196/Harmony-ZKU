#include "circom.hpp"
#include "calcwit.hpp"
#define NSignals 6272
#define NComponents 64
#define NOutputs 3
#define NInputs 8
#define NVars 4767
#define NPublic 11
...
move
*/
void move_0d0f17a2c3f687b4(Circom_CalcWit *ctx, int __cIdx) {
    ...
    int _diffX_sigIdx_;
    int _diffY_sigIdx_;
    int _firstDistSquare_sigIdx_;
    int _secondDistSquare_sigIdx_;
    int _compIdx_14;
    int _in_sigIdx__12;
    int _offset_12;
    int _compIdx_15;
    ...
    int _diffX1_sigIdx_;
    int _diffY1_sigIdx_;
    int _firstDistSquare1_sigIdx_;
    int _secondDistSquare1_sigIdx_;
    int _compIdx_17;
    int _in_sigIdx__14;
    int _offset_14;
    int _compIdx_18;
    ...
    int _diffX2_sigIdx_;
    int _diffY2_sigIdx_;
    int _firstDistSquare2_sigIdx_;
    int _secondDistSquare2_sigIdx_;
    int _compIdx_20;
    int _in_sigIdx__16;
    int _offset_16;
    int _compIdx_21;
    ...
    Circom_Sizes _sigSizes_ins_3;
    Circom_Sizes _sigSizes_ins_4;
    Circom_Sizes _sigSizes_ins_5;
    ...
    _x3_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x08f10507b58d6d5cLL /* x3 */);
    _y3_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x08ed8507b58a5e05LL /* y3 */);
    _x2Sq_sigIdx_ = ctx->getSignalOffset(__cIdx, 0xdb74b1535c1d19dfLL /* x2Sq */);
    _y2Sq_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x46d7db4a7abfb8a6LL /* y2Sq */);
    _r_sigIdx_ = ctx->getSignalOffset(__cIdx, 0xaf63ef4c86020cd5LL /* r */);
    _rSq_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x895aaf19607af059LL /* rSq */);
    _x3Sq_sigIdx_ = ctx->getSignalOffset(__cIdx, 0xd0bf985355780464LL /* x3Sq */);
    _y3Sq_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x51a8044a817bb109LL /* y3Sq */);
    _r3Sq_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x1e490420c6cb0b26LL /* r3Sq */);
    _diffX_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x8a95239960713366LL /* diffX */);
    _diffY_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x8a95249960713519LL /* diffY */);
    _firstDistSquare_sigIdx_ = ctx->getSignalOffset(__cIdx, 0xd2ce0b1f74fecb56LL /* firstDistSquare */);
    _secondDistSquare_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x57460877f33a8702LL /* secondDistSquare */);
    _energy_sigIdx_ = ctx->getSignalOffset(__cIdx, 0xf2fd4f9140ef2f15LL /* energy */);
    _diffX1_sigIdx_ = ctx->getSignalOffset(__cIdx, 0xec9ed49ee05a3cd5LL /* diffX1 */);
    _diffY1_sigIdx_ = ctx->getSignalOffset(__cIdx, 0xeca2589ee05d52f8LL /* diffY1 */);
    _firstDistSquare1_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x32e84d73ccf3a005LL /* firstDistSquare1 */);
    _secondDistSquare1_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x868796d24c73bba9LL /* secondDistSquare1 */);
    _diffX2_sigIdx_ = ctx->getSignalOffset(__cIdx, 0xec9ed19ee05a37bcLL /* diffX2 */);
    _diffY2_sigIdx_ = ctx->getSignalOffset(__cIdx, 0xeca25b9ee05d5811LL /* diffY2 */);
    _firstDistSquare2_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x32e84a73ccf39aecLL /* firstDistSquare2 */);
    _secondDistSquare2_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x868793d24c73b690LL /* secondDistSquare2 */);
    _diffY3_sigIdx_ = ctx->getSignalOffset(__cIdx, 0xeca25a9ee05d565eLL /* diffY3 */);
    _compx1_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x5291ee7c8b472a85LL /* compx1 */);
    _compx2_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x5291eb7c8b47256cLL /* compx2 */);
    _compx3_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x5291ec7c8b47271fLL /* compx3 */);
    _triangleArea_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x876f228cf3aaddc4LL /* triangleArea */);
    _pub1_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x6c45c60e273065afLL /* pub1 */);
    _pub2_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x6c45c70e27306762LL /* pub2 */);
    _pub3_sigIdx_ = ctx->getSignalOffset(__cIdx, 0x6c45c80e27306915LL /* pub3 */);
    /* signal  input x1 */
    /* signal  input y1 */
    /* signal  input x2 */
    /* signal  input y2 */
    ...
    /* rpx1x2.in[0] <== x1 */
    _compIdx = ctx->getSubComponentOffset(__cIdx, 0x25b68c232f98833aLL /* rpx1x2 */);
    ...
    _offset = _in_sigIdx_;
    ctx->multiGetSignal(__cIdx, __cIdx, _x1_sigIdx_, _sigValue, 1);
    ctx->setSignal(__cIdx, _compIdx, _offset, _sigValue);
    /* rpx1x2.in[1] <== y1 */
    _compIdx_1 = ctx->getSubComponentOffset(__cIdx, 0x25b68c232f98833aLL /* rpx1x2 */);
    ...
    ctx->multiGetSignal(__cIdx, __cIdx, _y1_sigIdx_, _sigValue_1, 1);
    ctx->setSignal(__cIdx, _compIdx_1, _offset_1, _sigValue_1);
    /* rpx1x2.in[2] <== x2 */
    _compIdx_2 = ctx->getSubComponentOffset(__cIdx, 0x25b68c232f98833aLL /* rpx1x2 */);
    ...
    _offset_2 = _in_sigIdx__2 + 2*_sigSizes_in_2[1];
    ctx->multiGetSignal(__cIdx, __cIdx, _x2_sigIdx_, _sigValue_2, 1);
    ctx->setSignal(__cIdx, _compIdx_2, _offset_2, _sigValue_2);
    /* rpx1x2.in[3] <== y2 */
    _compIdx_3 = ctx->getSubComponentOffset(__cIdx, 0x25b68c232f98833aLL /* rpx1x2 */);
    ...
    _offset_3 = _in_sigIdx__3 + 3*_sigSizes_in_3[1];
    ctx->multiGetSignal(__cIdx, __cIdx, _y2_sigIdx_, _sigValue_3, 1);
    ctx->setSignal(__cIdx, _compIdx_3, _offset_3, _sigValue_3);
    /* component rpx2x3 = MultiRangeProof(4, 40, 2 ** 32) */
    /* rpx2x3.in[0] <== x2 */
    _compIdx_4 = ctx->getSubComponentOffset(__cIdx, 0x3f0ff8233dc6156cLL /* rpx2x3 */);
    ...
    ctx->multiGetSignal(__cIdx, __cIdx, _x2_sigIdx_, _sigValue_4, 1);
    ctx->setSignal(__cIdx, _compIdx_4, _offset_4, _sigValue_4);
    /* rpx2x3.in[1] <== y2 */
    _compIdx_5 = ctx->getSubComponentOffset(__cIdx, 0x3f0ff8233dc6156cLL /* rpx2x3 */);
    ...
    ctx->multiGetSignal(__cIdx, __cIdx, _y2_sigIdx_, _sigValue_5, 1);
    ctx->setSignal(__cIdx, _compIdx_5, _offset_5, _sigValue_5);
    /* rpx2x3.in[2] <== x3 */
    _compIdx_6 = ctx->getSubComponentOffset(__cIdx, 0x3f0ff8233dc6156cLL /* rpx2x3 */);
    ...
    _offset_6 = _in_sigIdx__6 + 2*_sigSizes_in_6[1];
    ctx->multiGetSignal(__cIdx, __cIdx, _x3_sigIdx_, _sigValue_6, 1);
    ctx->setSignal(__cIdx, _compIdx_6, _offset_6, _sigValue_6);
    /* rpx2x3.in[3] <== y3 */
    _compIdx_7 = ctx->getSubComponentOffset(__cIdx, 0x3f0ff8233dc6156cLL /* rpx2x3 */);
    ...
    _offset_7 = _in_sigIdx__7 + 3*_sigSizes_in_7[1];
    ctx->multiGetSignal(__cIdx, __cIdx, _y3_sigIdx_, _sigValue_7, 1);
    ctx->setSignal(__cIdx, _compIdx_7, _offset_7, _sigValue_7);
    /* component comp2 = LessThan(32) */
    /* signal x2Sq */
    /* signal y2Sq */
    /* signal rSq */
    /* x2Sq <== x2 * x2 */
    ctx->multiGetSignal(__cIdx, __cIdx, _x2_sigIdx_, _sigValue_8, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _x2_sigIdx_, _sigValue_9, 1);
    Fr_mul(_tmp, _sigValue_8, _sigValue_9);
    ctx->setSignal(__cIdx, __cIdx, _x2Sq_sigIdx_, _tmp);
    /* y2Sq <== y2 * y2 */
    ctx->multiGetSignal(__cIdx, __cIdx, _y2_sigIdx_, _sigValue_10, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _y2_sigIdx_, _sigValue_11, 1);
    Fr_mul(_tmp_1, _sigValue_10, _sigValue_11);
    ctx->setSignal(__cIdx, __cIdx, _y2Sq_sigIdx_, _tmp_1);
    /* rSq <== r * r */
    ctx->multiGetSignal(__cIdx, __cIdx, _r_sigIdx_, _sigValue_12, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _r_sigIdx_, _sigValue_13, 1);
    Fr_mul(_tmp_2, _sigValue_12, _sigValue_13);
    ctx->setSignal(__cIdx, __cIdx, _rSq_sigIdx_, _tmp_2);
    /* comp2.in[0] <== x2Sq + y2Sq */
    _compIdx_8 = ctx->getSubComponentOffset(__cIdx, 0x6d36588e1dbe7448LL /* comp2 */);
    ...
    _offset_8 = _in_sigIdx__8;
    ctx->multiGetSignal(__cIdx, __cIdx, _x2Sq_sigIdx_, _sigValue_14, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _y2Sq_sigIdx_, _sigValue_15, 1);
    Fr_add(_tmp_3, _sigValue_14, _sigValue_15);
    ctx->setSignal(__cIdx, _compIdx_8, _offset_8, _tmp_3);
    /* comp2.in[1] <== rSq */
    _compIdx_9 = ctx->getSubComponentOffset(__cIdx, 0x6d36588e1dbe7448LL /* comp2 */);
    ...
    _offset_9 = _in_sigIdx__9 + 1*_sigSizes_in_9[1];
    ctx->multiGetSignal(__cIdx, __cIdx, _rSq_sigIdx_, _sigValue_16, 1);
    ctx->setSignal(__cIdx, _compIdx_9, _offset_9, _sigValue_16);
    /* comp2.out === 1 */
    _compIdx_10 = ctx->getSubComponentOffset(__cIdx, 0x6d36588e1dbe7448LL /* comp2 */);
    _out_sigIdx_ = ctx->getSignalOffset(_compIdx_10, 0x19f79b1921bbcfffLL /* out */);
    ctx->multiGetSignal(__cIdx, _compIdx_10, _out_sigIdx_, _sigValue_17, 1);
    ctx->checkConstraint(__cIdx, _sigValue_17, (ctx->circuit->constants + 1), "C:\Users\Harsh\OneDrive\Desktop\Harmony\Week3 Assignment\Question 1 Dark Forest\circuit.circom:57:4");
    /* component comp3 = LessThan(32) */
    /* signal x3Sq */
    /* signal y3Sq */
    /* signal r3Sq */
    /* x3Sq <== x3 * x3 */
    ctx->multiGetSignal(__cIdx, __cIdx, _x3_sigIdx_, _sigValue_18, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _x3_sigIdx_, _sigValue_19, 1);
    Fr_mul(_tmp_4, _sigValue_18, _sigValue_19);
    ctx->setSignal(__cIdx, __cIdx, _x3Sq_sigIdx_, _tmp_4);
    /* y3Sq <== y3 * y3 */
    ctx->multiGetSignal(__cIdx, __cIdx, _y3_sigIdx_, _sigValue_20, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _y3_sigIdx_, _sigValue_21, 1);
    Fr_mul(_tmp_5, _sigValue_20, _sigValue_21);
    ctx->setSignal(__cIdx, __cIdx, _y3Sq_sigIdx_, _tmp_5);
    /* r3Sq <== r * r */
    ctx->multiGetSignal(__cIdx, __cIdx, _r_sigIdx_, _sigValue_22, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _r_sigIdx_, _sigValue_23, 1);
    Fr_mul(_tmp_6, _sigValue_22, _sigValue_23);
    ctx->setSignal(__cIdx, __cIdx, _r3Sq_sigIdx_, _tmp_6);
    /* comp3.in[0] <== x3Sq + y3Sq */
    _compIdx_11 = ctx->getSubComponentOffset(__cIdx, 0x6d36598e1dbe75fbLL /* comp3 */);
    _in_sigIdx__10 = ctx->getSignalOffset(_compIdx_11, 0x08b73807b55c4bbeLL /* in */);
    _sigSizes_in_10 = ctx->getSignalSizes(_compIdx_11, 0x08b73807b55c4bbeLL /* in */);
    _offset_10 = _in_sigIdx__10;
    ctx->multiGetSignal(__cIdx, __cIdx, _x3Sq_sigIdx_, _sigValue_24, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _y3Sq_sigIdx_, _sigValue_25, 1);
    Fr_add(_tmp_7, _sigValue_24, _sigValue_25);
    ctx->setSignal(__cIdx, _compIdx_11, _offset_10, _tmp_7);
    /* comp3.in[1] <== r3Sq */
    _compIdx_12 = ctx->getSubComponentOffset(__cIdx, 0x6d36598e1dbe75fbLL /* comp3 */);
    ...
    _offset_11 = _in_sigIdx__11 + 1*_sigSizes_in_11[1];
    ctx->multiGetSignal(__cIdx, __cIdx, _r3Sq_sigIdx_, _sigValue_26, 1);
    ctx->setSignal(__cIdx, _compIdx_12, _offset_11, _sigValue_26);
    /* comp3.out === 1 */
    _compIdx_13 = ctx->getSubComponentOffset(__cIdx, 0x6d36598e1dbe75fbLL /* comp3 */);
    _out_sigIdx__1 = ctx->getSignalOffset(_compIdx_13, 0x19f79b1921bbcfffLL /* out */);
    ctx->multiGetSignal(__cIdx, _compIdx_13, _out_sigIdx__1, _sigValue_27, 1);
    ctx->checkConstraint(__cIdx, _sigValue_27, (ctx->circuit->constants + 1), "C:\Users\Harsh\OneDrive\Desktop\Harmony\Week3 Assignment\Question 1 Dark Forest\circuit.circom:70:4");
    /* signal diffX */
    /* diffX <== x1 - x2 */
    ctx->multiGetSignal(__cIdx, __cIdx, _x1_sigIdx_, _sigValue_28, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _x2_sigIdx_, _sigValue_29, 1);
    Fr_sub(_tmp_8, _sigValue_28, _sigValue_29);
    ctx->setSignal(__cIdx, __cIdx, _diffX_sigIdx_, _tmp_8);
    /* signal diffY */
    /* diffY <== y1 - y2 */
    ctx->multiGetSignal(__cIdx, __cIdx, _y1_sigIdx_, _sigValue_30, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _y2_sigIdx_, _sigValue_31, 1);
    Fr_sub(_tmp_9, _sigValue_30, _sigValue_31);
    ctx->setSignal(__cIdx, __cIdx, _diffY_sigIdx_, _tmp_9);
    /* component ltDist = LessThan(32) */
    /* signal firstDistSquare */
    /* signal secondDistSquare */
    /* firstDistSquare <== diffX * diffX */
    ctx->multiGetSignal(__cIdx, __cIdx, _diffX_sigIdx_, _sigValue_32, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _diffX_sigIdx_, _sigValue_33, 1);
    Fr_mul(_tmp_10, _sigValue_32, _sigValue_33);
    ctx->setSignal(__cIdx, __cIdx, _firstDistSquare_sigIdx_, _tmp_10);
    /* secondDistSquare <== diffY * diffY */
    ctx->multiGetSignal(__cIdx, __cIdx, _diffY_sigIdx_, _sigValue_34, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _diffY_sigIdx_, _sigValue_35, 1);
    Fr_mul(_tmp_11, _sigValue_34, _sigValue_35);
    ctx->setSignal(__cIdx, __cIdx, _secondDistSquare_sigIdx_, _tmp_11);
    /* ltDist.in[0] <== firstDistSquare + secondDistSquare */
    _compIdx_14 = ctx->getSubComponentOffset(__cIdx, 0xba56442cb7fb4801LL /* ltDist */);
    ...
    _offset_12 = _in_sigIdx__12;
    ctx->multiGetSignal(__cIdx, __cIdx, _firstDistSquare_sigIdx_, _sigValue_36, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _secondDistSquare_sigIdx_, _sigValue_37, 1);
    Fr_add(_tmp_12, _sigValue_36, _sigValue_37);
    ctx->setSignal(__cIdx, _compIdx_14, _offset_12, _tmp_12);
    /* ltDist.in[1] <== energy * energy + 1 */
    _compIdx_15 = ctx->getSubComponentOffset(__cIdx, 0xba56442cb7fb4801LL /* ltDist */);
    _in_sigIdx__13 = ctx->getSignalOffset(_compIdx_15, 0x08b73807b55c4bbeLL /* in */);
    _sigSizes_in_13 = ctx->getSignalSizes(_compIdx_15, 0x08b73807b55c4bbeLL /* in */);
    _offset_13 = _in_sigIdx__13 + 1*_sigSizes_in_13[1];
    ctx->multiGetSignal(__cIdx, __cIdx, _energy_sigIdx_, _sigValue_38, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _energy_sigIdx_, _sigValue_39, 1);
    Fr_mul(_tmp_13, _sigValue_38, _sigValue_39);
    Fr_add(_tmp_14, _tmp_13, (ctx->circuit->constants + 1));
    ctx->setSignal(__cIdx, _compIdx_15, _offset_13, _tmp_14);
    /* ltDist.out === 1 */
    _compIdx_16 = ctx->getSubComponentOffset(__cIdx, 0xba56442cb7fb4801LL /* ltDist */);
    _out_sigIdx__2 = ctx->getSignalOffset(_compIdx_16, 0x19f79b1921bbcfffLL /* out */);
    ctx->multiGetSignal(__cIdx, _compIdx_16, _out_sigIdx__2, _sigValue_40, 1);
    ctx->checkConstraint(__cIdx, _sigValue_40, (ctx->circuit->constants + 1), "C:\Users\Harsh\OneDrive\Desktop\Harmony\Week3 Assignment\Question 1 Dark Forest\circuit.circom:86:4");
    /* signal diffX1 */
    /* diffX1 <== x1 - x2 */
    ctx->multiGetSignal(__cIdx, __cIdx, _x1_sigIdx_, _sigValue_41, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _x2_sigIdx_, _sigValue_42, 1);
    Fr_sub(_tmp_15, _sigValue_41, _sigValue_42);
    ctx->setSignal(__cIdx, __cIdx, _diffX1_sigIdx_, _tmp_15);
    /* signal diffY1 */
    /* diffY1 <== y1 - y2 */
    ctx->multiGetSignal(__cIdx, __cIdx, _y1_sigIdx_, _sigValue_43, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _y2_sigIdx_, _sigValue_44, 1);
    Fr_sub(_tmp_16, _sigValue_43, _sigValue_44);
    ctx->setSignal(__cIdx, __cIdx, _diffY1_sigIdx_, _tmp_16);
    /* component ltDist1 = LessThan(32) */
    /* signal firstDistSquare1 */
    /* signal secondDistSquare1 */
    /* firstDistSquare1 <== diffX1 * diffX1 */
    ctx->multiGetSignal(__cIdx, __cIdx, _diffX1_sigIdx_, _sigValue_45, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _diffX1_sigIdx_, _sigValue_46, 1);
    Fr_mul(_tmp_17, _sigValue_45, _sigValue_46);
    ctx->setSignal(__cIdx, __cIdx, _firstDistSquare1_sigIdx_, _tmp_17);
    /* secondDistSquare1 <== diffY1 * diffY1 */
    ctx->multiGetSignal(__cIdx, __cIdx, _diffY1_sigIdx_, _sigValue_47, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _diffY1_sigIdx_, _sigValue_48, 1);
    Fr_mul(_tmp_18, _sigValue_47, _sigValue_48);
    ctx->setSignal(__cIdx, __cIdx, _secondDistSquare1_sigIdx_, _tmp_18);
    /* ltDist1.in[0] <== firstDistSquare1 + secondDistSquare1 */
    _compIdx_17 = ctx->getSubComponentOffset(__cIdx, 0x9bde07fc9ffba990LL /* ltDist1 */);
    _in_sigIdx__14 = ctx->getSignalOffset(_compIdx_17, 0x08b73807b55c4bbeLL /* in */);
    _sigSizes_in_14 = ctx->getSignalSizes(_compIdx_17, 0x08b73807b55c4bbeLL /* in */);
    _offset_14 = _in_sigIdx__14;
    ctx->multiGetSignal(__cIdx, __cIdx, _firstDistSquare1_sigIdx_, _sigValue_49, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _secondDistSquare1_sigIdx_, _sigValue_50, 1);
    Fr_add(_tmp_19, _sigValue_49, _sigValue_50);
    ctx->setSignal(__cIdx, _compIdx_17, _offset_14, _tmp_19);
    /* ltDist1.in[1] <== energy * energy + 1 */
    _compIdx_18 = ctx->getSubComponentOffset(__cIdx, 0x9bde07fc9ffba990LL /* ltDist1 */);
    _in_sigIdx__15 = ctx->getSignalOffset(_compIdx_18, 0x08b73807b55c4bbeLL /* in */);
    _sigSizes_in_15 = ctx->getSignalSizes(_compIdx_18, 0x08b73807b55c4bbeLL /* in */);
    _offset_15 = _in_sigIdx__15 + 1*_sigSizes_in_15[1];
    ctx->multiGetSignal(__cIdx, __cIdx, _energy_sigIdx_, _sigValue_51, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _energy_sigIdx_, _sigValue_52, 1);
    Fr_mul(_tmp_20, _sigValue_51, _sigValue_52);
    Fr_add(_tmp_21, _tmp_20, (ctx->circuit->constants + 1));
    ctx->setSignal(__cIdx, _compIdx_18, _offset_15, _tmp_21);
    /* ltDist1.out === 1 */
    _compIdx_19 = ctx->getSubComponentOffset(__cIdx, 0x9bde07fc9ffba990LL /* ltDist1 */);
    _out_sigIdx__3 = ctx->getSignalOffset(_compIdx_19, 0x19f79b1921bbcfffLL /* out */);
    ctx->multiGetSignal(__cIdx, _compIdx_19, _out_sigIdx__3, _sigValue_53, 1);
    ctx->checkConstraint(__cIdx, _sigValue_53, (ctx->circuit->constants + 1), "C:\Users\Harsh\OneDrive\Desktop\Harmony\Week3 Assignment\Question 1 Dark Forest\circuit.circom:102:4");
    /* signal diffX2 */
    /* diffX2 <== x2 - x3 */
    ctx->multiGetSignal(__cIdx, __cIdx, _x2_sigIdx_, _sigValue_54, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _x3_sigIdx_, _sigValue_55, 1);
    Fr_sub(_tmp_22, _sigValue_54, _sigValue_55);
    ctx->setSignal(__cIdx, __cIdx, _diffX2_sigIdx_, _tmp_22);
    /* signal diffY2 */
    /* diffY2 <== y2 - y3 */
    ctx->multiGetSignal(__cIdx, __cIdx, _y2_sigIdx_, _sigValue_56, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _y3_sigIdx_, _sigValue_57, 1);
    Fr_sub(_tmp_23, _sigValue_56, _sigValue_57);
    ctx->setSignal(__cIdx, __cIdx, _diffY2_sigIdx_, _tmp_23);
    /* component ltDist2 = LessThan(32) */
    /* signal firstDistSquare2 */
    /* signal secondDistSquare2 */
    /* firstDistSquare2 <== diffX2 * diffX2 */
    ctx->multiGetSignal(__cIdx, __cIdx, _diffX2_sigIdx_, _sigValue_58, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _diffX2_sigIdx_, _sigValue_59, 1);
    Fr_mul(_tmp_24, _sigValue_58, _sigValue_59);
    ctx->setSignal(__cIdx, __cIdx, _firstDistSquare2_sigIdx_, _tmp_24);
    /* secondDistSquare2 <== diffY2 * diffY2 */
    ctx->multiGetSignal(__cIdx, __cIdx, _diffY2_sigIdx_, _sigValue_60, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _diffY2_sigIdx_, _sigValue_61, 1);
    Fr_mul(_tmp_25, _sigValue_60, _sigValue_61);
    ctx->setSignal(__cIdx, __cIdx, _secondDistSquare2_sigIdx_, _tmp_25);
    /* ltDist2.in[0] <== firstDistSquare2 + secondDistSquare2 */
    _compIdx_20 = ctx->getSubComponentOffset(__cIdx, 0x9bde0afc9ffbaea9LL /* ltDist2 */);
    _in_sigIdx__16 = ctx->getSignalOffset(_compIdx_20, 0x08b73807b55c4bbeLL /* in */);
    _sigSizes_in_16 = ctx->getSignalSizes(_compIdx_20, 0x08b73807b55c4bbeLL /* in */);
    _offset_16 = _in_sigIdx__16;
    ctx->multiGetSignal(__cIdx, __cIdx, _firstDistSquare2_sigIdx_, _sigValue_62, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _secondDistSquare2_sigIdx_, _sigValue_63, 1);
    Fr_add(_tmp_26, _sigValue_62, _sigValue_63);
    ctx->setSignal(__cIdx, _compIdx_20, _offset_16, _tmp_26);
    /* ltDist2.in[1] <== energy * energy + 1 */
    _compIdx_21 = ctx->getSubComponentOffset(__cIdx, 0x9bde0afc9ffbaea9LL /* ltDist2 */);
    _in_sigIdx__17 = ctx->getSignalOffset(_compIdx_21, 0x08b73807b55c4bbeLL /* in */);
    _sigSizes_in_17 = ctx->getSignalSizes(_compIdx_21, 0x08b73807b55c4bbeLL /* in */);
    _offset_17 = _in_sigIdx__17 + 1*_sigSizes_in_17[1];
    ctx->multiGetSignal(__cIdx, __cIdx, _energy_sigIdx_, _sigValue_64, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _energy_sigIdx_, _sigValue_65, 1);
    Fr_mul(_tmp_27, _sigValue_64, _sigValue_65);
    Fr_add(_tmp_28, _tmp_27, (ctx->circuit->constants + 1));
    ctx->setSignal(__cIdx, _compIdx_21, _offset_17, _tmp_28);
    /* ltDist2.out === 1 */
    _compIdx_22 = ctx->getSubComponentOffset(__cIdx, 0x9bde0afc9ffbaea9LL /* ltDist2 */);
    _out_sigIdx__4 = ctx->getSignalOffset(_compIdx_22, 0x19f79b1921bbcfffLL /* out */);
    ctx->multiGetSignal(__cIdx, _compIdx_22, _out_sigIdx__4, _sigValue_66, 1);
    ctx->checkConstraint(__cIdx, _sigValue_66, (ctx->circuit->constants + 1), "C:\Users\Harsh\OneDrive\Desktop\Harmony\Week3 Assignment\Question 1 Dark Forest\circuit.circom:118:4");
    /* signal diffY3 */
    /* diffY3 <== y3 - y1 */
    ctx->multiGetSignal(__cIdx, __cIdx, _y3_sigIdx_, _sigValue_67, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _y1_sigIdx_, _sigValue_68, 1);
    Fr_sub(_tmp_29, _sigValue_67, _sigValue_68);
    ctx->setSignal(__cIdx, __cIdx, _diffY3_sigIdx_, _tmp_29);
    /* signal compx1 */
    /* compx1 <== x1*diffY2 */
    ctx->multiGetSignal(__cIdx, __cIdx, _x1_sigIdx_, _sigValue_69, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _diffY2_sigIdx_, _sigValue_70, 1);
    Fr_mul(_tmp_30, _sigValue_69, _sigValue_70);
    ctx->setSignal(__cIdx, __cIdx, _compx1_sigIdx_, _tmp_30);
    /* signal compx2 */
    /* compx2 <== x2*diffY3 */
    ctx->multiGetSignal(__cIdx, __cIdx, _x2_sigIdx_, _sigValue_71, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _diffY3_sigIdx_, _sigValue_72, 1);
    Fr_mul(_tmp_31, _sigValue_71, _sigValue_72);
    ctx->setSignal(__cIdx, __cIdx, _compx2_sigIdx_, _tmp_31);
    /* signal compx3 */
    /* compx3 <== x3*diffY1 */
    ctx->multiGetSignal(__cIdx, __cIdx, _x3_sigIdx_, _sigValue_73, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _diffY1_sigIdx_, _sigValue_74, 1);
    Fr_mul(_tmp_32, _sigValue_73, _sigValue_74);
    ctx->setSignal(__cIdx, __cIdx, _compx3_sigIdx_, _tmp_32);
    /* signal triangleArea */
    /* triangleArea <== (1/2)*(compx1+compx2+compx3) */
    ctx->multiGetSignal(__cIdx, __cIdx, _compx1_sigIdx_, _sigValue_75, 1);
    ctx->multiGetSignal(__cIdx, __cIdx, _compx2_sigIdx_, _sigValue_76, 1);
    Fr_add(_tmp_34, _sigValue_75, _sigValue_76);
    ctx->multiGetSignal(__cIdx, __cIdx, _compx3_sigIdx_, _sigValue_77, 1);
    Fr_add(_tmp_35, _tmp_34, _sigValue_77);
    Fr_mul(_tmp_36, (ctx->circuit->constants + 2), _tmp_35);
    ctx->setSignal(__cIdx, __cIdx, _triangleArea_sigIdx_, _tmp_36);
    /* component isEqual_ = IsEqual() */
    /* isEqual_.in[0] <== triangleArea */
    _compIdx_23 = ctx->getSubComponentOffset(__cIdx, 0x14d55fad3ded8ec0LL /* isEqual_ */);
    _in_sigIdx__18 = ctx->getSignalOffset(_compIdx_23, 0x08b73807b55c4bbeLL /* in */);
    _sigSizes_in_18 = ctx->getSignalSizes(_compIdx_23, 0x08b73807b55c4bbeLL /* in */);
    _offset_18 = _in_sigIdx__18;
    ctx->multiGetSignal(__cIdx, __cIdx, _triangleArea_sigIdx_, _sigValue_78, 1);
    ctx->setSignal(__cIdx, _compIdx_23, _offset_18, _sigValue_78);
    /* isEqual_.in[1] <== 0 */
    _compIdx_24 = ctx->getSubComponentOffset(__cIdx, 0x14d55fad3ded8ec0LL /* isEqual_ */);
    _in_sigIdx__19 = ctx->getSignalOffset(_compIdx_24, 0x08b73807b55c4bbeLL /* in */);
    _sigSizes_in_19 = ctx->getSignalSizes(_compIdx_24, 0x08b73807b55c4bbeLL /* in */);
    _offset_19 = _in_sigIdx__19 + 1*_sigSizes_in_19[1];
    ctx->setSignal(__cIdx, _compIdx_24, _offset_19, (ctx->circuit->constants + 0));
    /* isEqual_.out === 0 */
    _compIdx_25 = ctx->getSubComponentOffset(__cIdx, 0x14d55fad3ded8ec0LL /* isEqual_ */);
    _out_sigIdx__5 = ctx->getSignalOffset(_compIdx_25, 0x19f79b1921bbcfffLL /* out */);
    ctx->multiGetSignal(__cIdx, _compIdx_25, _out_sigIdx__5, _sigValue_79, 1);
    ctx->checkConstraint(__cIdx, _sigValue_79, (ctx->circuit->constants + 0), "C:\Users\Harsh\OneDrive\Desktop\Harmony\Week3 Assignment\Question 1 Dark Forest\circuit.circom:135:4");
    /* component mimc1 = MiMCSponge(2, 220, 1) */
    /* component mimc2 = MiMCSponge(2, 220, 1) */
    /* component mimc3 = MiMCSponge(2, 220, 1) */
    /* mimc1.ins[0] <== x1 */
    _compIdx_26 = ctx->getSubComponentOffset(__cIdx, 0x8bf79b62be29a88eLL /* mimc1 */);
    _ins_sigIdx_ = ctx->getSignalOffset(_compIdx_26, 0x2ba002192bd4cd57LL /* ins */);
    _sigSizes_ins = ctx->getSignalSizes(_compIdx_26, 0x2ba002192bd4cd57LL /* ins */);
    _offset_20 = _ins_sigIdx_;
    ctx->multiGetSignal(__cIdx, __cIdx, _x1_sigIdx_, _sigValue_80, 1);
    ctx->setSignal(__cIdx, _compIdx_26, _offset_20, _sigValue_80);
    /* mimc1.ins[1] <== y1 */
    _compIdx_27 = ctx->getSubComponentOffset(__cIdx, 0x8bf79b62be29a88eLL /* mimc1 */);
    _ins_sigIdx__1 = ctx->getSignalOffset(_compIdx_27, 0x2ba002192bd4cd57LL /* ins */);
    _sigSizes_ins_1 = ctx->getSignalSizes(_compIdx_27, 0x2ba002192bd4cd57LL /* ins */);
    _offset_21 = _ins_sigIdx__1 + 1*_sigSizes_ins_1[1];
    ctx->multiGetSignal(__cIdx, __cIdx, _y1_sigIdx_, _sigValue_81, 1);
    ctx->setSignal(__cIdx, _compIdx_27, _offset_21, _sigValue_81);
    /* mimc1.k <== 0 */
    _compIdx_28 = ctx->getSubComponentOffset(__cIdx, 0x8bf79b62be29a88eLL /* mimc1 */);
    _k_sigIdx_ = ctx->getSignalOffset(_compIdx_28, 0xaf63e64c8601fd8aLL /* k */);
    ctx->setSignal(__cIdx, _compIdx_28, _k_sigIdx_, (ctx->circuit->constants + 0));
    /* mimc2.ins[0] <== x2 */
    _compIdx_29 = ctx->getSubComponentOffset(__cIdx, 0x8bf79a62be29a6dbLL /* mimc2 */);
    _ins_sigIdx__2 = ctx->getSignalOffset(_compIdx_29, 0x2ba002192bd4cd57LL /* ins */);
    _sigSizes_ins_2 = ctx->getSignalSizes(_compIdx_29, 0x2ba002192bd4cd57LL /* ins */);
    _offset_22 = _ins_sigIdx__2;
    ctx->multiGetSignal(__cIdx, __cIdx, _x2_sigIdx_, _sigValue_82, 1);
    ctx->setSignal(__cIdx, _compIdx_29, _offset_22, _sigValue_82);
    /* mimc2.ins[1] <== y2 */
    _compIdx_30 = ctx->getSubComponentOffset(__cIdx, 0x8bf79a62be29a6dbLL /* mimc2 */);
    _ins_sigIdx__3 = ctx->getSignalOffset(_compIdx_30, 0x2ba002192bd4cd57LL /* ins */);
    _sigSizes_ins_3 = ctx->getSignalSizes(_compIdx_30, 0x2ba002192bd4cd57LL /* ins */);
    _offset_23 = _ins_sigIdx__3 + 1*_sigSizes_ins_3[1];
    ctx->multiGetSignal(__cIdx, __cIdx, _y2_sigIdx_, _sigValue_83, 1);
    ctx->setSignal(__cIdx, _compIdx_30, _offset_23, _sigValue_83);
    /* mimc2.k <== 0 */
    _compIdx_31 = ctx->getSubComponentOffset(__cIdx, 0x8bf79a62be29a6dbLL /* mimc2 */);
    _k_sigIdx__1 = ctx->getSignalOffset(_compIdx_31, 0xaf63e64c8601fd8aLL /* k */);
    ctx->setSignal(__cIdx, _compIdx_31, _k_sigIdx__1, (ctx->circuit->constants + 0));
    /* mimc3.ins[0] <== x3 */
    _compIdx_32 = ctx->getSubComponentOffset(__cIdx, 0x8bf79962be29a528LL /* mimc3 */);
    _ins_sigIdx__4 = ctx->getSignalOffset(_compIdx_32, 0x2ba002192bd4cd57LL /* ins */);
    _sigSizes_ins_4 = ctx->getSignalSizes(_compIdx_32, 0x2ba002192bd4cd57LL /* ins */);
    _offset_24 = _ins_sigIdx__4;
    ctx->multiGetSignal(__cIdx, __cIdx, _x3_sigIdx_, _sigValue_84, 1);
    ctx->setSignal(__cIdx, _compIdx_32, _offset_24, _sigValue_84);
    /* mimc3.ins[1] <== y3 */
    _compIdx_33 = ctx->getSubComponentOffset(__cIdx, 0x8bf79962be29a528LL /* mimc3 */);
    _ins_sigIdx__5 = ctx->getSignalOffset(_compIdx_33, 0x2ba002192bd4cd57LL /* ins */);
    _sigSizes_ins_5 = ctx->getSignalSizes(_compIdx_33, 0x2ba002192bd4cd57LL /* ins */);
    _offset_25 = _ins_sigIdx__5 + 1*_sigSizes_ins_5[1];
    ctx->multiGetSignal(__cIdx, __cIdx, _y3_sigIdx_, _sigValue_85, 1);
    ctx->setSignal(__cIdx, _compIdx_33, _offset_25, _sigValue_85);
    /* mimc3.k <== 0 */
    _compIdx_34 = ctx->getSubComponentOffset(__cIdx, 0x8bf79962be29a528LL /* mimc3 */);
    _k_sigIdx__2 = ctx->getSignalOffset(_compIdx_34, 0xaf63e64c8601fd8aLL /* k */);
    ctx->setSignal(__cIdx, _compIdx_34, _k_sigIdx__2, (ctx->circuit->constants + 0));
    /* pub1 <== mimc1.outs[0] */
    _compIdx_35 = ctx->getSubComponentOffset(__cIdx, 0x8bf79b62be29a88eLL /* mimc1 */);
    _outs_sigIdx_ = ctx->getSignalOffset(_compIdx_35, 0xdb8c17b45221aae4LL /* outs */);
    _sigSizes_outs = ctx->getSignalSizes(_compIdx_35, 0xdb8c17b45221aae4LL /* outs */);
    _offset_26 = _outs_sigIdx_;
    ctx->multiGetSignal(__cIdx, _compIdx_35, _offset_26, _sigValue_86, 1);
    ctx->setSignal(__cIdx, __cIdx, _pub1_sigIdx_, _sigValue_86);
    /* pub2 <== mimc2.outs[0] */
    _compIdx_36 = ctx->getSubComponentOffset(__cIdx, 0x8bf79a62be29a6dbLL /* mimc2 */);
    _outs_sigIdx__1 = ctx->getSignalOffset(_compIdx_36, 0xdb8c17b45221aae4LL /* outs */);
    _sigSizes_outs_1 = ctx->getSignalSizes(_compIdx_36, 0xdb8c17b45221aae4LL /* outs */);
    _offset_27 = _outs_sigIdx__1;
    ctx->multiGetSignal(__cIdx, _compIdx_36, _offset_27, _sigValue_87, 1);
    ctx->setSignal(__cIdx, __cIdx, _pub2_sigIdx_, _sigValue_87);
    /* pub3 <== mimc3.outs[0] */
    _compIdx_37 = ctx->getSubComponentOffset(__cIdx, 0x8bf79962be29a528LL /* mimc3 */);
    _outs_sigIdx__2 = ctx->getSignalOffset(_compIdx_37, 0xdb8c17b45221aae4LL /* outs */);
    _sigSizes_outs_2 = ctx->getSignalSizes(_compIdx_37, 0xdb8c17b45221aae4LL /* outs */);
    _offset_28 = _outs_sigIdx__2;
    ctx->multiGetSignal(__cIdx, _compIdx_37, _offset_28, _sigValue_88, 1);
    ctx->setSignal(__cIdx, __cIdx, _pub3_sigIdx_, _sigValue_88);
    ctx->finished(__cIdx);
}
/*
MultiRangeProof
bits=40
max_abs_value=4294967296
n=4
*/
void MultiRangeProof_f7e4a7e4da2d8d01(Circom_CalcWit *ctx, int __cIdx) {
    FrElement _sigValue[1];
    FrElement _tmp_3[1];
    FrElement i[1];
    FrElement _sigValue_1[1];
    ...
    _compIdx = ctx->getSubComponentOffset(__cIdx, 0xdc8a2f55012015bdLL /* rangeProofs */);
    _compSizes = ctx->getSubComponentSizes(__cIdx, 0xdc8a2f55012015bdLL /* rangeProofs */);
    _offset_5 = _compIdx;
    _in_sigIdx_ = ctx->getSignalOffset(_offset_5, 0x08b73807b55c4bbeLL /* in */);
    _offset_7 = _in_sigIdx__1;
    ctx->multiGetSignal(__cIdx, __cIdx, _offset_7, _sigValue, 1);
    ctx->setSignal(__cIdx, _offset_5, _in_sigIdx_, _sigValue);
    _loopCond = _tmp_3;
    while (Fr_isTrue(_loopCond)) {
        /* rangeProofs[i] = RangeProof(bits, max_abs_value) */
        /* rangeProofs[i].in <== in[i] */
        _compIdx_1 = ctx->getSubComponentOffset(__cIdx, 0xdc8a2f55012015bdLL /* rangeProofs */);
        _compSizes_1 = ctx->getSubComponentSizes(__cIdx, 0xdc8a2f55012015bdLL /* rangeProofs */);
        _offset_13 = _compIdx_1 + Fr_toInt(i)*_compSizes_1[1];
        _in_sigIdx__2 = ctx->getSignalOffset(_offset_13, 0x08b73807b55c4bbeLL /* in */);
        _offset_15 = _in_sigIdx__1 + Fr_toInt(i)*_sigSizes_in[1];
        ctx->multiGetSignal(__cIdx, __cIdx, _offset_15, _sigValue_1, 1);
        ctx->setSignal(__cIdx, _offset_13, _in_sigIdx__2, _sigValue_1);
        Fr_copyn(_tmp_5, i, 1);
...
max_abs_value=4294967296
*/
void RangeProof_78f6229df3abdbf1(Circom_CalcWit *ctx, int __cIdx) {
    FrElement _sigValue[1];
    FrElement _tmp[1];
    FrElement _sigValue_1[1];
    FrElement _sigValue_2[1];
    ...
    _compIdx = ctx->getSubComponentOffset(__cIdx, 0xfba266e63e080e9aLL /* lowerBound */);
    _in_sigIdx_ = ctx->getSignalOffset(_compIdx, 0x08b73807b55c4bbeLL /* in */);
    _sigSizes_in = ctx->getSignalSizes(_compIdx, 0x08b73807b55c4bbeLL /* in */);
    _offset = _in_sigIdx_;
    ctx->multiGetSignal(__cIdx, __cIdx, _in_sigIdx__1, _sigValue, 1);
    Fr_add(_tmp, (ctx->circuit->constants + 4), _sigValue);
    ctx->setSignal(__cIdx, _compIdx, _offset, _tmp);
    /* lowerBound.in[1] <== 0 */
    _compIdx_1 = ctx->getSubComponentOffset(__cIdx, 0xfba266e63e080e9aLL /* lowerBound */);
    _in_sigIdx__2 = ctx->getSignalOffset(_compIdx_1, 0x08b73807b55c4bbeLL /* in */);
    _sigSizes_in_1 = ctx->getSignalSizes(_compIdx_1, 0x08b73807b55c4bbeLL /* in */);
    _offset_2 = _in_sigIdx__2 + 1*_sigSizes_in_1[1];
    ctx->setSignal(__cIdx, _compIdx_1, _offset_2, (ctx->circuit->constants + 0));
    /* lowerBound.out === 0 */
    _compIdx_2 = ctx->getSubComponentOffset(__cIdx, 0xfba266e63e080e9aLL /* lowerBound */);
    ...
    ctx->checkConstraint(__cIdx, _sigValue_1, (ctx->circuit->constants + 0), "C:\Users\Harsh\OneDrive\Desktop\Harmony\Week3 Assignment\Question 1 Dark Forest\range-proof.circom:17:4");
    /* upperBound.in[0] <== 2 * max_abs_value */
    _compIdx_3 = ctx->getSubComponentOffset(__cIdx, 0xd2ee1538107b5705LL /* upperBound */);
    _in_sigIdx__3 = ctx->getSignalOffset(_compIdx_3, 0x08b73807b55c4bbeLL /* in */);
    _sigSizes_in_2 = ctx->getSignalSizes(_compIdx_3, 0x08b73807b55c4bbeLL /* in */);
    _offset_3 = _in_sigIdx__3;
    ctx->setSignal(__cIdx, _compIdx_3, _offset_3, (ctx->circuit->constants + 5));
    /* upperBound.in[1] <== max_abs_value + in */
    _compIdx_4 = ctx->getSubComponentOffset(__cIdx, 0xd2ee1538107b5705LL /* upperBound */);
    _in_sigIdx__4 = ctx->getSignalOffset(_compIdx_4, 0x08b73807b55c4bbeLL /* in */);
    _sigSizes_in_3 = ctx->getSignalSizes(_compIdx_4, 0x08b73807b55c4bbeLL /* in */);
    _offset_5 = _in_sigIdx__4 + 1*_sigSizes_in_3[1];
    ctx->multiGetSignal(__cIdx, __cIdx, _in_sigIdx__1, _sigValue_2, 1);
    Fr_add(_tmp_2, (ctx->circuit->constants + 4), _sigValue_2);
    ctx->setSignal(__cIdx, _compIdx_4, _offset_5, _tmp_2);
    /* upperBound.out === 0 */
    _compIdx_5 = ctx->getSubComponentOffset(__cIdx, 0xd2ee1538107b5705LL /* upperBound */);
    ...
    ctx->checkConstraint(__cIdx, _sigValue_3, (ctx->circuit->constants + 0), "C:\Users\Harsh\OneDrive\Desktop\Harmony\Week3 Assignment\Question 1 Dark Forest\range-proof.circom:21:4");
    ctx->finished(__cIdx);
}
/*
LessThan
...
n=40
*/
void LessThan_3d311764210c66b1(Circom_CalcWit *ctx, int __cIdx) {
    FrElement _sigValue[1];
    FrElement _tmp_2[1];
    FrElement _sigValue_1[1];
    FrElement _tmp_3[1];
    ...
    _sigSizes_in = ctx->getSignalSizes(__cIdx, 0x08b73807b55c4bbeLL /* in */);
    /* assert(n <= 252) */
    ctx->checkAssert(__cIdx, (ctx->circuit->constants + 1), "C:\Users\Harsh\OneDrive\Desktop\Harmony\Week3 Assignment\node_modules\circomlib\circuits\comparators.circom:90:4");
    /* signal input in[2] */
    /* signal output out */
    ...
    _offset_5 = _out_sigIdx_ + 40*_sigSizes_out[1];
...
n=41
*/
void Num2Bits_98704aa0f48ee3e9(Circom_CalcWit *ctx, int __cIdx) {
    FrElement _sigValue[1];
    FrElement _tmp_1[1];
    FrElement _tmp_2[1];
    FrElement _sigValue_1[1];
    ...
    ctx->checkConstraint(__cIdx, _tmp_4, (ctx->circuit->constants + 0), "C:\Users\Harsh\OneDrive\Desktop\Harmony\Week3 Assignment\node_modules\circomlib\circuits\bitify.circom:33:8");
    /* lc1 += out[i] * e2 */
    ...
    while (Fr_isTrue(_loopCond)) {
        ...
        ctx->checkConstraint(__cIdx, _tmp_14, (ctx->circuit->constants + 0), "C:\Users\Harsh\OneDrive\Desktop\Harmony\Week3 Assignment\node_modules\circomlib\circuits\bitify.circom:33:8");
        /* lc1 += out[i] * e2 */
    ...
    ctx->checkConstraint(__cIdx, lc1, _sigValue_8, "C:\Users\Harsh\OneDrive\Desktop\Harmony\Week3 Assignment\node_modules\circomlib\circuits\bitify.circom:38:4");
    ctx->finished(__cIdx);
}
/*
LessThan
...
n=40
*/
void LessThan_4f4415326f6e18f8(Circom_CalcWit *ctx, int __cIdx) {
    FrElement _sigValue[1];
    FrElement _tmp_2[1];
    FrElement _sigValue_1[1];
    FrElement _tmp_3[1];
...
void LessThan_ebb56912d4e23de7(Circom_CalcWit *ctx, int __cIdx) {
    ...
    _offset_1 = _in_sigIdx__1;
    ctx->multiGetSignal(__cIdx, __cIdx, _offset_1, _sigValue, 1);
    Fr_add(_tmp_2, _sigValue, (ctx->circuit->constants + 4));
    _offset_3 = _in_sigIdx__1 + 1*_sigSizes_in[1];
    ctx->multiGetSignal(__cIdx, __cIdx, _offset_3, _sigValue_1, 1);
    Fr_sub(_tmp_3, _tmp_2, _sigValue_1);
    ctx->setSignal(__cIdx, _compIdx, _in_sigIdx_, _tmp_3);
    ...
    _out_sigIdx_ = ctx->getSignalOffset(_compIdx_1, 0x19f79b1921bbcfffLL /* out */);
    _sigSizes_out = ctx->getSignalSizes(_compIdx_1, 0x19f79b1921bbcfffLL /* out */);
    _offset_5 = _out_sigIdx_ + 32*_sigSizes_out[1];
    ctx->multiGetSignal(__cIdx, _compIdx_1, _offset_5, _sigValue_2, 1);
    Fr_sub(_tmp_4, (ctx->circuit->constants + 1), _sigValue_2);
    ctx->setSignal(__cIdx, __cIdx, _out_sigIdx__1, _tmp_4);
    ctx->finished(__cIdx);
...
n=33
*/
void Num2Bits_985f48a0f4806d50(Circom_CalcWit *ctx, int __cIdx) {
    FrElement _sigValue[1];
    FrElement _tmp_1[1];
    FrElement _tmp_2[1];
    FrElement _sigValue_1[1];
...
in[1]=0
*/
void IsEqual_08a6631e379c63e6(Circom_CalcWit *ctx, int __cIdx) {
    FrElement _sigValue[1];
    FrElement _sigValue_1[1];
    FrElement _tmp[1];
    FrElement _sigValue_2[1];
...
void IsZero_0a2b8515b81b5ef3(Circom_CalcWit *ctx, int __cIdx) {
    ...
    ctx->checkConstraint(__cIdx, _tmp_5, (ctx->circuit->constants + 0), "C:\Users\Harsh\OneDrive\Desktop\Harmony\Week3 Assignment\node_modules\circomlib\circuits\comparators.circom:33:4");
    ctx->finished(__cIdx);
}
/*
MiMCSponge
...
void MiMCSponge_9ec0aed9ecb0041f(Circom_CalcWit *ctx, int __cIdx) {
    ...
    while (Fr_isTrue(_loopCond)) {
        ...
        Fr_copyn(i, _tmp_9, 1);
        Fr_lt(_tmp_11, i, (ctx->circuit->constants + 7));
        _loopCond = _tmp_11;
    }
    ...
    while (Fr_isTrue(_loopCond_1)) {
        ...
        Fr_add(_tmp_15, (ctx->circuit->constants + 7), i);
        ...
        Fr_add(_tmp_16, (ctx->circuit->constants + 7), i);
        ...
        Fr_add(_tmp_17, (ctx->circuit->constants + 7), i);
        ...
        Fr_add(_tmp_19, (ctx->circuit->constants + 7), i);
        ...
        Fr_add(_tmp_20, (ctx->circuit->constants + 7), i);
        ...
        Fr_add(_tmp_22, (ctx->circuit->constants + 7), i);
...
void MiMCFeistel_4721f7651191669c(Circom_CalcWit *ctx, int __cIdx) {
    ...
    Fr_copy(&(c_partial[0]), ctx->circuit->constants +11);
    Fr_copy(&(c_partial[1]), ctx->circuit->constants +12);
    Fr_copy(&(c_partial[2]), ctx->circuit->constants +13);
    Fr_copy(&(c_partial[3]), ctx->circuit->constants +14);
    Fr_copy(&(c_partial[4]), ctx->circuit->constants +15);
    Fr_copy(&(c_partial[5]), ctx->circuit->constants +16);
    Fr_copy(&(c_partial[6]), ctx->circuit->constants +17);
    Fr_copy(&(c_partial[7]), ctx->circuit->constants +18);
    Fr_copy(&(c_partial[8]), ctx->circuit->constants +19);
    Fr_copy(&(c_partial[9]), ctx->circuit->constants +20);
    Fr_copy(&(c_partial[10]), ctx->circuit->constants +21);
    Fr_copy(&(c_partial[11]), ctx->circuit->constants +22);
    Fr_copy(&(c_partial[12]), ctx->circuit->constants +23);
    Fr_copy(&(c_partial[13]), ctx->circuit->constants +24);
    Fr_copy(&(c_partial[14]), ctx->circuit->constants +25);
    Fr_copy(&(c_partial[15]), ctx->circuit->constants +26);
    Fr_copy(&(c_partial[16]), ctx->circuit->constants +27);
    Fr_copy(&(c_partial[17]), ctx->circuit->constants +28);
    Fr_copy(&(c_partial[18]), ctx->circuit->constants +29);
    Fr_copy(&(c_partial[19]), ctx->circuit->constants +30);
    Fr_copy(&(c_partial[20]), ctx->circuit->constants +31);
    Fr_copy(&(c_partial[21]), ctx->circuit->constants +32);
    Fr_copy(&(c_partial[22]), ctx->circuit->constants +33);
    Fr_copy(&(c_partial[23]), ctx->circuit->constants +34);
    Fr_copy(&(c_partial[24]), ctx->circuit->constants +35);
    Fr_copy(&(c_partial[25]), ctx->circuit->constants +36);
    Fr_copy(&(c_partial[26]), ctx->circuit->constants +37);
    Fr_copy(&(c_partial[27]), ctx->circuit->constants +38);
    Fr_copy(&(c_partial[28]), ctx->circuit->constants +39);
    Fr_copy(&(c_partial[29]), ctx->circuit->constants +40);
    Fr_copy(&(c_partial[30]), ctx->circuit->constants +41);
    Fr_copy(&(c_partial[31]), ctx->circuit->constants +42);
    Fr_copy(&(c_partial[32]), ctx->circuit->constants +43);
    Fr_copy(&(c_partial[33]), ctx->circuit->constants +44);
    Fr_copy(&(c_partial[34]), ctx->circuit->constants +45);
    Fr_copy(&(c_partial[35]), ctx->circuit->constants +46);
    Fr_copy(&(c_partial[36]), ctx->circuit->constants +47);
    Fr_copy(&(c_partial[37]), ctx->circuit->constants +48);
    Fr_copy(&(c_partial[38]), ctx->circuit->constants +49);
    Fr_copy(&(c_partial[39]), ctx->circuit->constants +50);
    Fr_copy(&(c_partial[40]), ctx->circuit->constants +51);
    Fr_copy(&(c_partial[41]), ctx->circuit->constants +52);
    Fr_copy(&(c_partial[42]), ctx->circuit->constants +53);
    Fr_copy(&(c_partial[43]), ctx->circuit->constants +54);
    Fr_copy(&(c_partial[44]), ctx->circuit->constants +55);
    Fr_copy(&(c_partial[45]), ctx->circuit->constants +56);
    Fr_copy(&(c_partial[46]), ctx->circuit->constants +57);
    Fr_copy(&(c_partial[47]), ctx->circuit->constants +58);
    Fr_copy(&(c_partial[48]), ctx->circuit->constants +59);
    Fr_copy(&(c_partial[49]), ctx->circuit->constants +60);
    Fr_copy(&(c_partial[50]), ctx->circuit->constants +61);
    Fr_copy(&(c_partial[51]), ctx->circuit->constants +62);
    Fr_copy(&(c_partial[52]), ctx->circuit->constants +63);
    Fr_copy(&(c_partial[53]), ctx->circuit->constants +64);
    Fr_copy(&(c_partial[54]), ctx->circuit->constants +65);
    Fr_copy(&(c_partial[55]), ctx->circuit->constants +66);
    Fr_copy(&(c_partial[56]), ctx->circuit->constants +67);
    Fr_copy(&(c_partial[57]), ctx->circuit->constants +68);
    Fr_copy(&(c_partial[58]), ctx->circuit->constants +69);
    Fr_copy(&(c_partial[59]), ctx->circuit->constants +70);
    Fr_copy(&(c_partial[60]), ctx->circuit->constants +71);
    Fr_copy(&(c_partial[61]), ctx->circuit->constants +72);
    Fr_copy(&(c_partial[62]), ctx->circuit->constants +73);
    Fr_copy(&(c_partial[63]), ctx->circuit->constants +74);
    Fr_copy(&(c_partial[64]), ctx->circuit->constants +75);
    Fr_copy(&(c_partial[65]), ctx->circuit->constants +76);
    Fr_copy(&(c_partial[66]), ctx->circuit->constants +77);
    Fr_copy(&(c_partial[67]), ctx->circuit->constants +78);
    Fr_copy(&(c_partial[68]), ctx->circuit->constants +79);
    Fr_copy(&(c_partial[69]), ctx->circuit->constants +80);
    Fr_copy(&(c_partial[70]), ctx->circuit->constants +81);
    Fr_copy(&(c_partial[71]), ctx->circuit->constants +82);
    Fr_copy(&(c_partial[72]), ctx->circuit->constants +83);
    Fr_copy(&(c_partial[73]), ctx->circuit->constants +84);
    Fr_copy(&(c_partial[74]), ctx->circuit->constants +85);
    Fr_copy(&(c_partial[75]), ctx->circuit->constants +86);
    Fr_copy(&(c_partial[76]), ctx->circuit->constants +87);
    Fr_copy(&(c_partial[77]), ctx->circuit->constants +88);
    Fr_copy(&(c_partial[78]), ctx->circuit->constants +89);
    Fr_copy(&(c_partial[79]), ctx->circuit->constants +90);
    Fr_copy(&(c_partial[80]), ctx->circuit->constants +91);
    Fr_copy(&(c_partial[81]), ctx->circuit->constants +92);
    Fr_copy(&(c_partial[82]), ctx->circuit->constants +93);
    Fr_copy(&(c_partial[83]), ctx->circuit->constants +94);
    Fr_copy(&(c_partial[84]), ctx->circuit->constants +95);
    Fr_copy(&(c_partial[85]), ctx->circuit->constants +96);
    Fr_copy(&(c_partial[86]), ctx->circuit->constants +97);
    Fr_copy(&(c_partial[87]), ctx->circuit->constants +98);
    Fr_copy(&(c_partial[88]), ctx->circuit->constants +99);
    Fr_copy(&(c_partial[89]), ctx->circuit->constants +100);
    Fr_copy(&(c_partial[90]), ctx->circuit->constants +101);
    Fr_copy(&(c_partial[91]), ctx->circuit->constants +102);
    Fr_copy(&(c_partial[92]), ctx->circuit->constants +103);
    Fr_copy(&(c_partial[93]), ctx->circuit->constants +104);
    Fr_copy(&(c_partial[94]), ctx->circuit->constants +105);
    Fr_copy(&(c_partial[95]), ctx->circuit->constants +106);
    Fr_copy(&(c_partial[96]), ctx->circuit->constants +107);
    Fr_copy(&(c_partial[97]), ctx->circuit->constants +108);
    Fr_copy(&(c_partial[98]), ctx->circuit->constants +109);
    Fr_copy(&(c_partial[99]), ctx->circuit->constants +110);
    Fr_copy(&(c_partial[100]), ctx->circuit->constants +111);
    Fr_copy(&(c_partial[101]), ctx->circuit->constants +112);
    Fr_copy(&(c_partial[102]), ctx->circuit->constants +113);
    Fr_copy(&(c_partial[103]), ctx->circuit->constants +114);
    Fr_copy(&(c_partial[104]), ctx->circuit->constants +115);
    Fr_copy(&(c_partial[105]), ctx->circuit->constants +116);
    Fr_copy(&(c_partial[106]), ctx->circuit->constants +117);
    Fr_copy(&(c_partial[107]), ctx->circuit->constants +118);
    Fr_copy(&(c_partial[108]), ctx->circuit->constants +119);
    Fr_copy(&(c_partial[109]), ctx->circuit->constants +120);
    Fr_copy(&(c_partial[110]), ctx->circuit->constants +121);
    Fr_copy(&(c_partial[111]), ctx->circuit->constants +122);
    Fr_copy(&(c_partial[112]), ctx->circuit->constants +123);
    Fr_copy(&(c_partial[113]), ctx->circuit->constants +124);
    Fr_copy(&(c_partial[114]), ctx->circuit->constants +125);
    Fr_copy(&(c_partial[115]), ctx->circuit->constants +126);
    Fr_copy(&(c_partial[116]), ctx->circuit->constants +127);
    Fr_copy(&(c_partial[117]), ctx->circuit->constants +128);
    Fr_copy(&(c_partial[118]), ctx->circuit->constants +129);
    Fr_copy(&(c_partial[119]), ctx->circuit->constants +130);
    Fr_copy(&(c_partial[120]), ctx->circuit->constants +131);
    Fr_copy(&(c_partial[121]), ctx->circuit->constants +132);
    Fr_copy(&(c_partial[122]), ctx->circuit->constants +133);
    Fr_copy(&(c_partial[123]), ctx->circuit->constants +134);
    Fr_copy(&(c_partial[124]), ctx->circuit->constants +135);
    Fr_copy(&(c_partial[125]), ctx->circuit->constants +136);
    Fr_copy(&(c_partial[126]), ctx->circuit->constants +137);
    Fr_copy(&(c_partial[127]), ctx->circuit->constants +138);
    Fr_copy(&(c_partial[128]), ctx->circuit->constants +139);
    Fr_copy(&(c_partial[129]), ctx->circuit->constants +140);
    Fr_copy(&(c_partial[130]), ctx->circuit->constants +141);
    Fr_copy(&(c_partial[131]), ctx->circuit->constants +142);
    Fr_copy(&(c_partial[132]), ctx->circuit->constants +143);
    Fr_copy(&(c_partial[133]), ctx->circuit->constants +144);
    Fr_copy(&(c_partial[134]), ctx->circuit->constants +145);
    Fr_copy(&(c_partial[135]), ctx->circuit->constants +146);
    Fr_copy(&(c_partial[136]), ctx->circuit->constants +147);
    Fr_copy(&(c_partial[137]), ctx->circuit->constants +148);
    Fr_copy(&(c_partial[138]), ctx->circuit->constants +149);
    Fr_copy(&(c_partial[139]), ctx->circuit->constants +150);
    Fr_copy(&(c_partial[140]), ctx->circuit->constants +151);
    Fr_copy(&(c_partial[141]), ctx->circuit->constants +152);
    Fr_copy(&(c_partial[142]), ctx->circuit->constants +153);
    Fr_copy(&(c_partial[143]), ctx->circuit->constants +154);
    Fr_copy(&(c_partial[144]), ctx->circuit->constants +155);
    Fr_copy(&(c_partial[145]), ctx->circuit->constants +156);
    Fr_copy(&(c_partial[146]), ctx->circuit->constants +157);
    Fr_copy(&(c_partial[147]), ctx->circuit->constants +158);
    Fr_copy(&(c_partial[148]), ctx->circuit->constants +159);
    Fr_copy(&(c_partial[149]), ctx->circuit->constants +160);
    Fr_copy(&(c_partial[150]), ctx->circuit->constants +161);
    Fr_copy(&(c_partial[151]), ctx->circuit->constants +162);
    Fr_copy(&(c_partial[152]), ctx->circuit->constants +163);
    Fr_copy(&(c_partial[153]), ctx->circuit->constants +164);
    Fr_copy(&(c_partial[154]), ctx->circuit->constants +165);
    Fr_copy(&(c_partial[155]), ctx->circuit->constants +166);
    Fr_copy(&(c_partial[156]), ctx->circuit->constants +167);
    Fr_copy(&(c_partial[157]), ctx->circuit->constants +168);
    Fr_copy(&(c_partial[158]), ctx->circuit->constants +169);
    Fr_copy(&(c_partial[159]), ctx->circuit->constants +170);
    Fr_copy(&(c_partial[160]), ctx->circuit->constants +171);
    Fr_copy(&(c_partial[161]), ctx->circuit->constants +172);
    Fr_copy(&(c_partial[162]), ctx->circuit->constants +173);
    Fr_copy(&(c_partial[163]), ctx->circuit->constants +174);
    Fr_copy(&(c_partial[164]), ctx->circuit->constants +175);
    Fr_copy(&(c_partial[165]), ctx->circuit->constants +176);
    Fr_copy(&(c_partial[166]), ctx->circuit->constants +177);
    Fr_copy(&(c_partial[167]), ctx->circuit->constants +178);
    Fr_copy(&(c_partial[168]), ctx->circuit->constants +179);
    Fr_copy(&(c_partial[169]), ctx->circuit->constants +180);
    Fr_copy(&(c_partial[170]), ctx->circuit->constants +181);
    Fr_copy(&(c_partial[171]), ctx->circuit->constants +182);
    Fr_copy(&(c_partial[172]), ctx->circuit->constants +183);
    Fr_copy(&(c_partial[173]), ctx->circuit->constants +184);
    Fr_copy(&(c_partial[174]), ctx->circuit->constants +185);
    Fr_copy(&(c_partial[175]), ctx->circuit->constants +186);
    Fr_copy(&(c_partial[176]), ctx->circuit->constants +187);
    Fr_copy(&(c_partial[177]), ctx->circuit->constants +188);
    Fr_copy(&(c_partial[178]), ctx->circuit->constants +189);
    Fr_copy(&(c_partial[179]), ctx->circuit->constants +190);
    Fr_copy(&(c_partial[180]), ctx->circuit->constants +191);
    Fr_copy(&(c_partial[181]), ctx->circuit->constants +192);
    Fr_copy(&(c_partial[182]), ctx->circuit->constants +193);
    Fr_copy(&(c_partial[183]), ctx->circuit->constants +194);
    Fr_copy(&(c_partial[184]), ctx->circuit->constants +195);
    Fr_copy(&(c_partial[185]), ctx->circuit->constants +196);
    Fr_copy(&(c_partial[186]), ctx->circuit->constants +197);
    Fr_copy(&(c_partial[187]), ctx->circuit->constants +198);
    Fr_copy(&(c_partial[188]), ctx->circuit->constants +199);
    Fr_copy(&(c_partial[189]), ctx->circuit->constants +200);
    Fr_copy(&(c_partial[190]), ctx->circuit->constants +201);
    Fr_copy(&(c_partial[191]), ctx->circuit->constants +202);
    Fr_copy(&(c_partial[192]), ctx->circuit->constants +203);
    Fr_copy(&(c_partial[193]), ctx->circuit->constants +204);
    Fr_copy(&(c_partial[194]), ctx->circuit->constants +205);
    Fr_copy(&(c_partial[195]), ctx->circuit->constants +206);
    Fr_copy(&(c_partial[196]), ctx->circuit->constants +207);
    Fr_copy(&(c_partial[197]), ctx->circuit->constants +208);
    Fr_copy(&(c_partial[198]), ctx->circuit->constants +209);
    Fr_copy(&(c_partial[199]), ctx->circuit->constants +210);
    Fr_copy(&(c_partial[200]), ctx->circuit->constants +211);
    Fr_copy(&(c_partial[201]), ctx->circuit->constants +212);
    Fr_copy(&(c_partial[202]), ctx->circuit->constants +213);
    Fr_copy(&(c_partial[203]), ctx->circuit->constants +214);
    Fr_copy(&(c_partial[204]), ctx->circuit->constants +215);
    Fr_copy(&(c_partial[205]), ctx->circuit->constants +216);
    Fr_copy(&(c_partial[206]), ctx->circuit->constants +217);
    Fr_copy(&(c_partial[207]), ctx->circuit->constants +218);
    Fr_copy(&(c_partial[208]), ctx->circuit->constants +219);
    Fr_copy(&(c_partial[209]), ctx->circuit->constants +220);
    Fr_copy(&(c_partial[210]), ctx->circuit->constants +221);
    Fr_copy(&(c_partial[211]), ctx->circuit->constants +222);
    Fr_copy(&(c_partial[212]), ctx->circuit->constants +223);
    Fr_copy(&(c_partial[213]), ctx->circuit->constants +224);
    Fr_copy(&(c_partial[214]), ctx->circuit->constants +225);
    Fr_copy(&(c_partial[215]), ctx->circuit->constants +226);
    Fr_copy(&(c_partial[216]), ctx->circuit->constants +227);
    Fr_copy(&(c_partial[217]), ctx->circuit->constants +228);
    ...
    Fr_copyn(aux, _sigValue_4, 1);
    /* xL[i] <== aux + t4[i]*t */
    _offset_30 = _t4_sigIdx_;
    ctx->multiGetSignal(__cIdx, __cIdx, _offset_30, _sigValue_5, 1);
    Fr_mul(_tmp_14, _sigValue_5, t);
    Fr_add(_tmp_15, aux, _tmp_14);
    _offset_33 = _xL_sigIdx_;
    ctx->setSignal(__cIdx, __cIdx, _offset_33, _tmp_15);
    /* xR[i] <== (i==0) ? xL_in : xL[i-1] */
    ctx->multiGetSignal(__cIdx, __cIdx, _xL_in_sigIdx_, _sigValue_6, 1);
    _offset_36 = _xR_sigIdx_;
    ctx->setSignal(__cIdx, __cIdx, _offset_36, _sigValue_6);
    _loopCond = _tmp_19;
    while (Fr_isTrue(_loopCond)) {
        /* if ((i == 0) || (i == nrounds - 1)) */
        Fr_eq(_tmp_20, i, (ctx->circuit->constants + 0));
        Fr_eq(_tmp_22, i, (ctx->circuit->constants + 10));
        ...
        if (Fr_isTrue(_tmp_23)) {
            ...
            _offset_46 = Fr_toInt(_tmp_24);
            _v_25 = c_partial + _offset_46;
            Fr_copyn(c, _v_25, 1);
        }
        /* t = (i==0) ? k+xL_in : k + xL[i-1] + c */
        ...
        if (Fr_isTrue(_tmp_25)) {
            ...
            _offset_50 = _xL_sigIdx_ + Fr_toInt(_tmp_27)*_sigSizes_xL[1];
            ctx->multiGetSignal(__cIdx, __cIdx, _offset_50, _sigValue_10, 1);
        ...
        ctx->setSignal(__cIdx, __cIdx, _offset_56, _tmp_30);
        /* t4[i] <== t2[i]*t2[i] */
        _offset_58 = _t2_sigIdx_ + Fr_toInt(i)*_sigSizes_t2[1];
        ctx->multiGetSignal(__cIdx, __cIdx, _offset_58, _sigValue_11, 1);
        _offset_60 = _t2_sigIdx_ + Fr_toInt(i)*_sigSizes_t2[1];
        ctx->multiGetSignal(__cIdx, __cIdx, _offset_60, _sigValue_12, 1);
        Fr_mul(_tmp_31, _sigValue_11, _sigValue_12);
        _offset_62 = _t4_sigIdx_ + Fr_toInt(i)*_sigSizes_t4[1];
        ctx->setSignal(__cIdx, __cIdx, _offset_62, _tmp_31);
        /* if (i<nrounds-1) */
        Fr_lt(_tmp_33, i, (ctx->circuit->constants + 10));
        if (Fr_isTrue(_tmp_33)) {
            ...
            if (Fr_isTrue(_tmp_34)) {
                ...
                _offset_67 = _xR_sigIdx_ + Fr_toInt(_tmp_35)*_sigSizes_xR[1];
                ctx->multiGetSignal(__cIdx, __cIdx, _offset_67, _sigValue_14, 1);
                _ter_1 = _sigValue_14;
            }
            Fr_copyn(aux, _ter_1, 1);
            /* xL[i] <== aux + t4[i]*t */
            _offset_71 = _t4_sigIdx_ + Fr_toInt(i)*_sigSizes_t4[1];
            ctx->multiGetSignal(__cIdx, __cIdx, _offset_71, _sigValue_15, 1);
            Fr_mul(_tmp_36, _sigValue_15, t);
            Fr_add(_tmp_37, aux, _tmp_36);
            _offset_74 = _xL_sigIdx_ + Fr_toInt(i)*_sigSizes_xL[1];
            ctx->setSignal(__cIdx, __cIdx, _offset_74, _tmp_37);
            /* xR[i] <== (i==0) ? xL_in : xL[i-1] */
            ...
            if (Fr_isTrue(_tmp_38)) {
                ...
                _offset_77 = _xL_sigIdx_ + Fr_toInt(_tmp_39)*_sigSizes_xL[1];
                ctx->multiGetSignal(__cIdx, __cIdx, _offset_77, _sigValue_17, 1);
                _ter_2 = _sigValue_17;
            }
            _offset_79 = _xR_sigIdx_ + Fr_toInt(i)*_sigSizes_xR[1];
            ctx->setSignal(__cIdx, __cIdx, _offset_79, _ter_2);
        } else {
            /* xR_out <== xR[i-1] + t4[i]*t */
            Fr_sub(_tmp_40, i, (ctx->circuit->constants + 1));
            _offset_81 = _xR_sigIdx_ + Fr_toInt(_tmp_40)*_sigSizes_xR[1];
            ctx->multiGetSignal(__cIdx, __cIdx, _offset_81, _sigValue_18, 1);
            _offset_83 = _t4_sigIdx_ + Fr_toInt(i)*_sigSizes_t4[1];
            ctx->multiGetSignal(__cIdx, __cIdx, _offset_83, _sigValue_19, 1);
            ...
            _offset_86 = _xL_sigIdx_ + Fr_toInt(_tmp_43)*_sigSizes_xL[1];
            ctx->multiGetSignal(__cIdx, __cIdx, _offset_86, _sigValue_20, 1);
        ...
        Fr_lt(_tmp_46, i, (ctx->circuit->constants + 229));
        _loopCond = _tmp_46;
    }
    ctx->finished(__cIdx);
}
...
// Function Table
Circom_ComponentFunction _functionTable[13] = {
     move_0d0f17a2c3f687b4
    ,MultiRangeProof_f7e4a7e4da2d8d01
    ,RangeProof_78f6229df3abdbf1
    ,LessThan_3d311764210c66b1
    ,Num2Bits_98704aa0f48ee3e9
    ,LessThan_4f4415326f6e18f8
    ,LessThan_ebb56912d4e23de7
    ,Num2Bits_985f48a0f4806d50
    ,IsEqual_08a6631e379c63e6
