...
describe('HarmonyProver', function () {
    beforeEach(async function () {
        ...
        //Deploy HarmonyProver contract with deployed add of MMRVerifier contract
    ...
    // Checking saved block header is same as header hash
    ...
    // Checking transaction receipt proof valid or not
...
describe('TokenLocker', function () {
    beforeEach(async function () {
        ...
        //Get TokenLockerOnEthereum contract address
